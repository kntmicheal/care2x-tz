...
$_SESSION['sess_file_forward'] = '';
$_SESSION['sess_file_return'] = '';
$_SESSION['sess_file_break'] = '';
$_SESSION['sess_path_referer'] = '';
$_SESSION['sess_dept_nr'] = '';
$_SESSION['sess_title'] = '';
$_SESSION['sess_lang'] = '';
$_SESSION['sess_user_id'] = '';
$_SESSION['sess_cur_page'] = '';
$_SESSION['sess_searchkey'] = '';
$_SESSION['sess_tos'] = '';
...
if (!isset($_SESSION['sess_user_origin']))
    $_SESSION['sess_user_origin'];
if (!isset($_SESSION['sess_file_forward']))
    $_SESSION['sess_file_forward'];
if (!isset($_SESSION['sess_file_return']))
    $_SESSION['sess_file_return'];
if (!isset($_SESSION['sess_file_break']))
    $_SESSION['sess_file_break'];
if (!isset($_SESSION['sess_path_referer']))
    $_SESSION['sess_path_referer'];
if (!isset($_SESSION['sess_dept_nr']))
    $_SESSION['sess_dept_nr'];
if (!isset($_SESSION['sess_title']))
    $_SESSION['sess_title'];
if (!isset($_SESSION['sess_lang']))
    $_SESSION['sess_lang'];
if (!isset($_SESSION['sess_user_id']))
    $_SESSION['sess_user_id'];
if (!isset($_SESSION['sess_cur_page']))
    $_SESSION['sess_cur_page'];
if (!isset($_SESSION['sess_searchkey']))
    $_SESSION['sess_searchkey'];
if (!isset($_SESSION['sess_tos']))
    $_SESSION['sess_tos'];# the session time out start time
...
if (empty($_SESSION['sess_user_name']))
    $_SESSION['sess_user_name'] = 'default';
