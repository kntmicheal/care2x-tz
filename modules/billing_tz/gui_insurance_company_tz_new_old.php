                    ...
                    <td bgcolor=#ffffff valign=top>
                        <form method="POST">
                            <table border="0" cellpadding="2" cellspacing="0" width="788">
                                ...
                                <tr bgcolor=ffffee>
                                    <td colspan="2"><input type="button" onClick="document.forms[0].sitetarget.value = 'menu';
                                            document.forms[0].submit();" value="<?php echo $LDCreateCompanyGoBack; ?>"></td>
                                    <td colspan="2" align="right"><input type="button" onClick="document.forms[0].sitetarget.value = 'contract';
                                            document.forms[0].submit();" value="<?php echo $LDCreateCompanyInsertContract; ?>"</td>
                                </tr>
                            </table>
                        </form>
                    </TD>
