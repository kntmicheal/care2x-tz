                        ...
                        <td height=75>
                            ...
                            <table border="0" cellpadding="2" cellspacing="0" width="788">
                                ...
                                <tr bgcolor=ffffaa>
                                    ...
                                    <td><?php echo $LDPaybyInvoice; ?> <?php if ($this_insurance['invoice_flag']) echo $LDYes;
else echo $LDNo; ?></td>
                                    <td><?php echo $LDGetsCompanyCredit; ?> <?php if ($this_insurance['credit_preselection_flag']) echo $LDYes;
else echo $LDNo; ?></td>
                                </tr>
                                <tr bgcolor=ffffee>
                                    <td><?php $insurance_tz->ShowRedIfError('Hide Company', $error['hide_company_flag']); ?>:</td>
                                    <td><?php if ($this_insurance['hide_company_flag']) echo $LDYes;
else echo $LDNo; ?></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
...
<?php $insurance_tz->ReportContractsOfCompany($id); ?>
