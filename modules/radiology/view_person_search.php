    ...
    for ($i = 0; $i < $z; $i++) {
        if ($pdata[$i]['pid'] != $pdata[($i - 1)]['pid']) {
            ...
            if ($rows == 1) {
                ...
                if ($pdata[($i + 1)] && ($pdata[$i]['pid'] == $pdata[($i + 1)]['pid']))
                    echo $img_t;
                else
                    echo $img_s;
            }
            ...
            if ($pdata[$i]['note_len'])
                echo '<a href="javascript:popImgNotes(\'' . $pdata[$i]['nr'] . '\',\'' . $sid . '\',\'' . $lang . '\')"><img ' . $img_info . '></a>';
            echo '</td>';
		...
		<tr>
				<td class="v12">&nbsp;';
        if ($pdata[$i]['encounter_nr'])
            echo $pdata[$i]['encounter_nr'];
        echo '&nbsp;</td>
			<td class="v12">&nbsp;</td>
			<td class="v12">&nbsp;</td>
			<td class="v12">&nbsp;</td>
