...
$rep_obj->DisplayInsuranceBillingTableHead($admission);
$rep_obj->DisplayInsuranceBillingTestSummary($start_timeframe, $end_timeframe, $admission);
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./credit_financial_report.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&admission="+admission;
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
                          ...
                          <?php $rep_obj->DisplayInsuranceBillingTableHead($admission);?>
