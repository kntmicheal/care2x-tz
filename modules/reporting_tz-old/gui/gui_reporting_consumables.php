...
<title>'.$LDConsSuppliesReport.'</title>
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./reporting_consumables.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&admission="+admission+"&bill_type="+bill_type;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDConsSuppliesReport; ?></font></td>
