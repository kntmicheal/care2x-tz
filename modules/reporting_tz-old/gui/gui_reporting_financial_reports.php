                            ...
                            <TR>
                                <TD><table cellpadding=3 cellspacing=1>
                                        <tbody class="submenu">
                                            ...
                                            <tr>
                                                <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                                                <td class="submenu_item"><a href="DetailedRevenue.php"><?php echo 'Detailed test'; ?></a></td>
                                                <td><?php echo 'Detailed test'; ?></td>
                                            </tr>

                                            <tr>
                                                <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                                                <td class="submenu_item"><a href="insurance_company_financial_MRH.php"><?php echo $LDDetailedRevenue; ?></a></td>
                                                <td><?php echo $LDDetailedRevenueTxt; ?></td>
                                            </tr>
                                            <tr>
                                                <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                                                <td class="submenu_item"><a href="DetailedRevenue.php"><?php echo $LDDetailedRevenue . " - Excel"; ?></a></td>
                                                <td><?php echo $LDDetailedRevenueTxt . " Excel Export"; ?></td>
                                            </tr>
