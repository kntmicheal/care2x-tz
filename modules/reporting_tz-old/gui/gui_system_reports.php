                        ...
                        <TBODY>
                            ...
                            <TR  height=1>
                                <TD colSpan=3 class="vspace">
                                    <IMG height=1 src="../../gui/img/common/default/pixel.gif" width=5>
                                </TD>
                            </TR>

                            <tr>
                                <td align=center><img src="../../gui/img/common/default/forums.gif" border=0 width="17" height="17"></td>
                                <td class="submenu_item"><a href="docs_consul_patients_pass.php"><?php echo $LDPatientsPerDoc; ?></a></td>
                                <td><?php echo $LDDocPatientsCons ?></td>
                            </tr>
                            <TR  height=1>
                                <TD colSpan=3 class="vspace">
                                    <IMG height=1 src="../../gui/img/common/default/pixel.gif" width=5>
