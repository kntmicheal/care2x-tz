                    ...
                    <table cellspacing="0"  class="titlebar" border=0>
                        <tr valign=top  class="titlebar" >
                            <td width="202" bgcolor="#99ccff" >
                                &nbsp;&nbsp;<font color="#330066"><?php echo $LDCTCReports; ?></font></td>
                                ...
                                <TD><table cellpadding=3 cellspacing=1>
                                        <tbody class="submenu">
                                            ...
                                            <tr>
                                                ...
                                                <td class="submenu_item"><a href="javascript:getCTC('modules/arv_2/arv_reporting_quarterly.php')">NACP Cross Sectional Report</a></td>
                                                <td>Quarterly Facility Based HIV Care/ART Reporting</td>
                                            </tr>
                                            <tr>
                                                <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                                                <td class="submenu_item"><a href="<?php echo $root_path ?>modules/reporting_tz/ctc_reports_cohort_reports_pass.php">NACP Cohort Reports</a></td>
                                                <td>Facility Based Cohort Reporting</td>
                                            </tr>
                                            <tr>
                                                <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                                                <!--<td class="submenu_item"><a href="<?php // echo $root_path ?>modules/arv_2/arv_reporting_cohort_ind.php">NACP Cohort Indicators Report</a></td>-->
                                                <td class="submenu_item"><a href="javascript:getCTC('modules/arv_2/arv_reporting_cohort_ind.php')">NACP Cohort Indicators Report</a></td>
                                                <td>Facility Based Cohort Indicators Reporting</td>
                                            </tr>
                                        </tbody>
                                    </table></TD>
                            </TR>
