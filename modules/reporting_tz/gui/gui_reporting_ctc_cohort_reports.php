                ...
                <td  valign="top" align="middle" height="35">
                    <table cellspacing="0"  class="titlebar" border=0>
                        <tr valign=top  class="titlebar" >
                            <td width="302" bgcolor="#99ccff" >
                                &nbsp;&nbsp;<font color="#330066"><?php echo $LDCTCCohortReports; ?></font></td>
                                ...
                                <TD><table cellpadding=3 cellspacing=1>
                                        <tbody class="submenu">
                                            ...
                                            <tr>
                                                ...
                                                <td class="submenu_item"><a href="javascript:getCTC('modules/arv_2/arv_reporting_cohort_quarterly.php')">NACP Quarterly Cohort Report</a></td>
                                                <td>Quarterly Cohort Reporting</td>
                                            </tr>
                                            <tr>
                                                <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                                                <td class="submenu_item"><a href="javascript:getCTC('modules/arv_2/arv_reporting_one_cohort.php')">One Cohort Report</a></td>
                                                <td>Six Years Cohort Reporting</td>
                                            </tr>
                                            <tr>
                                                <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                                                <td class="submenu_item"><a href="javascript:getCTC('modules/arv_2/arv_reporting_six_cohorts.php')">Six Cohorts Report</a></td>
                                                <td>Two Years Cohort Reporting</td>
                                            </tr>
                                        </tbody>
                                    </table></TD>
                            </TR>
