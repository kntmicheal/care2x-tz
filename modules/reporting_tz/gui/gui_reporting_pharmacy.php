...
<tr><td><?php echo $data['dawa'][$i]['partcode'];?></td><td><?php echo $data['dawa'][$i]['description'];?><b><?php echo $class;?></b></td><td><?php echo number_format($data['dawa'][$i]['unit_price'],2);?></td><td><?php echo $data['dawa'][$i]['qty'];?></td><td><?php echo number_format($data['dawa'][$i]['unit_price']*$data['dawa'][$i]['qty'],2);?></td></td></tr>
<?php
}
?>
