...
$rep_obj->DisplayDeletedQuotationsTableHead($pricelist);
$rep_obj->DisplayDeletedQuotationsSummary($start_timeframe, $end_timeframe, $pricelist);
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    function printOut(start_timeframe, end_timeframe, pricelist)
    {
    	urlholder="./deleted_quotations_report.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&pricelist="+pricelist;
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<?php require_once($root_path.$top_dir.'include/inc_gui_timeframe_pricelist.php'); ?>
                          ...
                          <?php $rep_obj->DisplayDeletedQuotationsTableHead($pricelist);?>

						  <?php $rep_obj->DisplayDeletedQuotationsSummary($start_timeframe, $end_timeframe, $pricelist);?>
						  <?php $rep_obj->DisplayDeletedQuotationsResultRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>
<a href="javascript:printOut(<?php echo $start_timeframe.",".$end_timeframe.",".$pricelist; ?>)"><img border=0 src=<?php echo $root_path;?>/gui/img/common/default/billing_print_out.gif></a><br>
						  <br><br><br>
