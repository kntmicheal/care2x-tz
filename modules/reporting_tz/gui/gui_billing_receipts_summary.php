...
<title>'.$LDBillingreceiptsReport.'</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>';
echo '<html><body>';
echo '<table width="500" border="1" cellspacing="0" cellpadding="0" align="center" ';
$rep_obj->DisplayCashReceiptsTableHead($admission);
$rep_obj->DisplayCashReceiptsTestSummary($start_timeframe, $end_timeframe,$admission);
$rep_obj->DisplayCashReceiptsRows($start_timeframe, $end_timeframe);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./billing_receipts_summary.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&admission"+admission;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Cash Receipts Report'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
                          ...
                          <?php $rep_obj->DisplayCashReceiptsTableHead($admission);?>

						  <?php $rep_obj->DisplayCashReceiptsTestSummary($start_timeframe, $end_timeframe, $admission);?>
						  <?php $rep_obj->DisplayCashReceiptsRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>
