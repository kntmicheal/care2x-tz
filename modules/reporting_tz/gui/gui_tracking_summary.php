...
<title>'.$LDTrackingReport.'</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>';
echo '<html><body>';
echo '<table width="500" border="1" cellspacing="0" cellpadding="0" align="center" ';
$rep_obj->DisplayTrackingTableHead();
$rep_obj->DisplayTrackingRows($start_timeframe, $end_timeframe);
echo '</table>';
echo '</html></body>';
exit();
}
...
<HEAD>
 ...
 <meta name="Author" content="Timo Hasselwander">
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    function printOutTracking(start_timeframe, end_timeframe)
    {
    	urlholder="./tracking_summary.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDTrackingReport; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
                          ...
                          <?php $rep_obj->DisplayTrackingTableHead();?>
                          <?php $rep_obj->DisplayTrackingRows($start_timeframe, $end_timeframe);?>


                          </table>
				</form>
<a href="javascript:printOutTracking(<?php echo $start_timeframe.",".$end_timeframe;?>)"><img border=0 src=<?php echo $root_path;?>/gui/img/common/default/billing_print_out.gif></a><br>
						  <br><br><br>
