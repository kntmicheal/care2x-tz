    ...
    <BODY BACKGROUND="leinwand.gif">
        ...
        <table width=100% border=0 cellpadding="0" cellspacing="0">
                ...
                <td ><p><br>
                    <ul>
                        ...
                        <FORM action="<? echo $thisfile; ?>" method="post">
                            ...
                            <B>Stichwort eingeben. z.B. Name, Vorname, Geburtsdatum, oder Abk�rzung u.s.w.</B></font><p>
                            ...
                            if (($versand != "")and ( $keyword)) {
                                ...
                                if ($link) {
                                    ...
                                    if (mysql_select_db($dbname, $link)) {
                                        if ($suchwort < 20000000)
                                            $suchbuffer = $suchwort + 20000000;
                                        else
                                            $suchbuffer = $suchwort;
			...
			ORDER BY care_admission_patient_patnum';
						...
						<font face="Arial,Verdana"  color="#000000" size=-1>
						Stichwort eingeben. z.B. Fallnummer, Name, Vorname, Geburtsdatum, oder Abk�rzung u.s.w.</B><p>
						...
						<p>';
                                            ...
                                            echo "<p>" . $sql . "<p>Das Lesen von Daten aus der Datenbank ist gescheitert.";
                                        };
                                    } else
                                        echo " Tabelle konnte nicht ausgew�hlt werden.";
                                }
                                else {
