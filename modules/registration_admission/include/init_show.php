...
if (!$GLOBAL_CONFIG['notes_preview_maxlen'])
    $GLOBAL_CONFIG['notes_preview_maxlen'] = 60; // hardcoded default value;
...
#Resolve $_SESSION['sess_en']

if (!isset($_SESSION['sess_en']) || empty($_SESSION['sess_en']) || $_SESSION['sess_en'] == 0) {
