...
if (isset($pid) && $pid) {
    ...
    ?>;
            if (d.encounter_class_nr[0] && d.encounter_class_nr[1] && !d.encounter_class_nr[0].checked && !d.encounter_class_nr[1].checked) {
                ...
                alert("PLEASE ENTER BLOCK PAYMENT, SELECT ITEMS UNDER CONSULTATION FIELD");
...
//							else $sTemp = $sTemp.$result['name'];
    ...
    $smarty->assign('form_nr', '<input name="form_nr" type="text" size="9" value="' . $form_nr . '">');
