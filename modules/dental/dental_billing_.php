...
if (($_GET['type']) &&
    ...
    if ((intval($_GET['total'])) < (intval($_GET['pay']))) {
        $paid = $_GET['total'];
    } else {
        $paid = $_GET['pay'];
    }
...
if (($_GET['types']) &&
    ...
    $getall = array(addslashes($_GET['encounter']), addslashes($_GET['types']), addslashes($_GET['short']), addslashes($_GET['notes']), addslashes($_GET['by']), addslashes($_GET['mode']), addslashes($_GET['nr']));
    $note_obj = new dental;
