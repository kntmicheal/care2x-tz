...
?>>
    ...
    <table width=100% border=0 cellpadding="0" cellspacing="0"> 
        ...
        <tr>
            <td colspan=3><?php
                if ($target == "entry")
                    echo '<img ' . createLDImgSrc($root_path, 'newdata-b.gif', '0') . ' alt="' . $LDNewData . '">';
                else {
                    echo'<a href="' . $thisfile . $append . '&target=entry"><img ' . createLDImgSrc($root_path, 'newdata-gray.gif', '0') . '  alt="' . $LDNewData . '" width=130 height=25 border=0 ';
                    if ($cfg['dhtml'])
