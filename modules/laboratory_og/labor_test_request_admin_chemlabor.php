...
if (!$mode) /* Get the pending test requests */ {
    $sql = "SELECT care_person.pid, care_person.selian_pid, UPPER(name_last) as name_last, CONCAT(name_first,'  ', name_2) AS name_first, batch_nr, tr.encounter_nr,tr.send_date,dept_nr,room_nr FROM care_test_request_" . $subtarget . " tr,
