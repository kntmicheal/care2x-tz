...
<BODY onLoad="document.sform.keyword.select()">
    ...
    <img <?php echo createComIcon($root_path, 'micros.gif', '0', 'absmiddle') ?>><FONT  COLOR="<?php echo $cfg[top_txtcolor] ?>"  SIZE=5> <b><?php echo "$LDMedLab - ";
if ($editmode) echo "$LDNewData";
else echo "$LDSeeData"; ?></b></font>
    ...
    <?php echo $pagen->makeSortLink($LDLastName, 'name_last', $oitem, $odir, $append); ?></b></td>
			...
			<tr class=';
                                ...
                                if ($zeile['encounter_class_nr'] == 2)
                                    echo ' <img ' . createComIcon($root_path, 'redflag.gif', '0', '', TRUE) . '> <font size=1 color="red">' . $LDAmbulant . '</font>';
