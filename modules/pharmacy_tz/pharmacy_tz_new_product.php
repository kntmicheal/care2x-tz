...
$short_1 = $short[0];
$long_1 = $long[0];
$is_insured_1 = $is_insurance[0];
$short_2 = $short[1];
$long_2 = $long[1];
$is_insured_2 = $is_insurance[1];
$short_3 = $short[2];
$long_3 = $long[2];
$is_insured_3 = $is_insurance[2];
$short_4 = $short[3];
$long_4 = $long[3];
$is_insured_4 = $is_insurance[3];

$short_5 = $short[4];
$long_5 = $long[4];
$is_insured_5 = $is_insurance[4];
$short_6 = $short[5];
$long_6 = $long[5];
$is_insured_6 = $is_insurance[5];
$short_7 = $short[6];
$long_7 = $long[6];
$is_insured_7 = $is_insurance[6];
...
if (!empty($mode) && !$ERROR) {
    ...
    if (empty($selians_item_price))
        $selians_item_price = "0";
    if (empty($selians_item_price_1))
        $selians_item_price_1 = "0";
    if (empty($selians_item_price_2))
        $selians_item_price_2 = "0";
    if (empty($selians_item_price_3))
        $selians_item_price_3 = "0";

    if (empty($selians_item_price_4))
        $selians_item_price_4 = "0";
    if (empty($selians_item_price_5))
        $selians_item_price_5 = "0";
    if (empty($selians_item_price_6))
        $selians_item_price_6 = "0";
