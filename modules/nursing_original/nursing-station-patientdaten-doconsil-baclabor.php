...
while (list($x, $v) = each($LDBacLabMaterialType)) {
    ...
    echo '</td>
	   <td>';
    if ($edit)
        echo '<a href="javascript:setM(\'' . $x2 . '\')">';
    ...
    if ($edit)
        echo '</a><input type="hidden" name="' . $x2 . '" value="' . $inp_v . '">';
    echo '</td>
	   </tr>';
}
?>		
	   ...
	   <td>';
                            if ($edit)
                                echo '<a href="javascript:setM(\'' . $x3 . '\')">';
                            ...
                            if ($edit)
                                echo '</a><input type="hidden" name="' . $x3 . '" value="' . $inp_v . '">';
                            echo '</td>
	   <td>';
                            if ($edit)
                                echo '<a href="javascript:setM(\'' . $x4 . '\')">';
                            ...
                            if ($edit)
                                echo '</a><input type="hidden" name="' . $x4 . '" value="' . $inp_v . '">';
                            echo '</td>
	   </tr>';
                        }
                        ?>		
...
if ($in_cache)
    echo '<img src="' . $root_path . 'cache/barcodes/form_' . $batch_nr . '.png"  border=0>';
?>
