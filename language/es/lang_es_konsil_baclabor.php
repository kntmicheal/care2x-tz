...
$LDLEN = 'NRL';  /* Lab entry number: N�mero de registro de laboratorio */
$LDDate = 'Date';
$LDEye = 'Ojo';
$LDBac_1 = 'Bact.1'; /* Nota: Bact. significa bacteria o pat�geno */
$LDBac_2 = 'Bact.2';
$LDBac_3 = 'Bact.3';
$LDBac_I = 'Pat�g.I';
$LDBac_II = 'Pat�g.II';
...
/* 2002-09-19 EL */
$LDBAC = array('Pat�g. I', 'Pat�g. II', 'Pat�g. III');
...
$lab_TestType = array('_lab_culture_aerob_' => 'C.aer.',
    ...
    '_lab_liquor_cult_vial' => 'KF.LCR (por confirmar t�rmino)',
    '_lab_laal_' => 'LAAL',
...
/* $lab_TestType = array('_lab_culture_aerob_' => 'Cultivo aerob',
  ...
  '_lab_liquor_cult_vial' => 'Cult.Fco.LCR (por confirmar t�rmino)',
  '_lab_laal_' => 'LAAL',
  '_lab_own_blood_' => 'Sangre propia',
  '_extra_1_' => ' ',
  '_extra_2_' => ' ',
  ...
  '_lab_gram_dye_1_' => 'Tinci�n Gram.1',
  ...
  '_lab_gram_dye_2_' => 'Tinci�n Gram.2',
  ...
  '_lab_gram_dye_3_' => 'Tinci�n Gram.3'
  ); */
...
$lab_TestResultId_2 = array('Sin crecimiento luego de 48 horas', 'Crecim. tipo aerobios', 'Negativo para amebas en heces',
    'Sin crecimiento luego de 5 d�as', '', 'Negativo para Lamblia en heces',
    'Sin crecimiento luego de 9 d�as', 'Sin evidencia de Diplococ. gramneg.', 'Neg. para huevos de nematodos en heces',
    'No Bact. del grupo TPE', 'Cultivo GO negativo', 'Sin crecimiento de E coli',
    'cultivo neg. Campylobacter.', '', 'Liquorant�geno (�Ag. LCR?) negativo',
    'NoG. Campylobacter pylori', 'Sin evid.microscp.acid.Cilind.', 'EHEC negativo',
    'Sin evid.serolog.dispepsia.coli', 'Sin crecimiento luego de 7 d�as', '',
