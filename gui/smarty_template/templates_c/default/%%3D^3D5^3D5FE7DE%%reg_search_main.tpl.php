<?php /* Smarty version 2.6.22, created on 2013-11-20 09:26:50
                    ...
                    <tr>
                        <td>
                            <form <?php echo $this->_tpl_vars['sFormParams']; ?>
                                ...
                                <p>
                                    <?php echo $this->_tpl_vars['sCheckBoxCTCNo']; ?>
                                    <?php echo $this->_tpl_vars['LDIncludeCTCNo']; ?>
...
<p>
    ...
    <table border=0 cellpadding=2 cellspacing=1>
        ...
        <tr class="reg_list_titlebar">
            ...
            <td><?php echo $this->_tpl_vars['LDCTCID']; ?>
            </td>
