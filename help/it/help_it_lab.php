    ...
    if ($src == "time") {
        ...
        switch ($x1) {
            ...
            case "cut_close": print "tempi di taglio e sutura";
                break;
            case "wait_time": print "tempi di attesa (inattivit�)";
                break;
...
<form action="#" >
    <?php if ($src == "person") : ?>
        ...
        <ul>       	
            <b>Nota: </b>Se si � scelto <?php echo $person ?> in un'operazione precedente, il nome sar� mostrato nella lista di selezione rapida.<p>
            ...
            Il chirurgo sar� automaticamente aggiunto nell'elenco "current entries".<p>
        </ul>
        <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
...
<?php if ($src == "time") : ?>
    <?php if ($x1 == "entry_out") : ?>
            ...
            <ul>       	
                ...
                <b>Nota: </b>E' possibile inserire pi� orari di inizio e fine e salvare tutto in una volta.<p>
            </ul>
    ...
    <?php if ($x1 == "cut_close") : ?>
            ...
            <ul>       	
                ...
                <b>Nota: </b>E' possibile inserire pi� orari di taglio e sutura e salvare tutto in una volta.<p>
            </ul>
    ...
    <?php if ($x1 == "wait_time") : ?>
            ...
            <ul>       	
                ...
                <b>3: </b>Scegliere la ragione dell'attesa tra quelle elencate nella terza colonna (Causa).<p>
                    <b>Nota: </b>E' possibile inserire pi� tempi iniziali, finali e ragioni e salvare tutto in una volta.<p>
            </ul>
    ...
    <?php if ($x1 == "bandage_time") : ?>
            ...
            <ul>       	
                ...
                <b>Nota: </b>E' possibile inserire pi� tempi iniziali e finali e salvare tutto in una volta.<p>
            </ul>
...
<?php if ($src == "create") : ?>
    <?php if ($x1 == "logmain") : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>I dati saranno copiati nell'editor, e sar� a questo punto possibile modificarli seguendo le istruzioni per
            ...
            <ul>       	
                ...
                <b>2: </b>Apparir� una finestrella con i dati paziente.<br>
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if ($x2 == "material") : ?>
            ...
            <ul>       	
                ...
                <ul>       	
                    <b>Nota: </b>Se la ricerca identifica un risultato, i dati del materiale sono copiati subito nel documento.<p> 
                        <b>Nota: </b>Se invece ci sono pi� risultati, apparir� una lista: selezionando il bottone <img <?php echo createComIcon('../', 'bul_arrowgrnlrg.gif', '0') ?>> oppure numero o nome dell'articolo desiderato, lo si inserir� nel documento.<p> 
                </ul>
                <b>3: </b>Una volta aggiunto l'articolo, si pu� cambiare la quantit� nel campo "<span style="background-color:yellow" > pezzi </span>" se necessario.<p> 
                <ul>       	
                    <b>Nota: </b>Una volta inserita la quantit�, compariranno i bottoni "Salva" ed "Annulla".<p> 
                </ul>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                L'articolo non � presente. Si pu� forzarne l'inserimento a mano?</b>
            </font>
            <ul> 
            ...
            <ul>       	
                ...
                <ul>       	
                    <b>Nota: </b>Se la ricerca identifica un risultato, i dati del paziente sono copiati subito nei campi appropriati.<p> 
                        <b>Nota: </b>Se invece ci sono pi� risultati, apparir� una lista: selezionare il nome o cognome del paziente per inserire i dati nel documento.<p> 
                </ul>
    ...
    <?php else : ?>
            ...
            <ul>       	
                ...
                <b>2: </b>Apparir� una finestrella in cui inserire le informazioni.<br>
            ...
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Come inserire pi� tempi in una volta sola</b>
            </font>
            <ul> <b>1: </b><p>    	
                    ...
                    <b>2: </b>Apparir� una finestralla in cui inserire il tempo impiegato. <br>
            ...
            <ul> <b>1: </b>Posizionarsi con il mouse sul punto nella scala dei tempi corrispondente al tipo desiderato (es. Fasciatura/ingessatura).<br>
                <b>2: </b>Selezionare l'orario sulla scala dei tempi.<p>
                    <b>Nota:</b> Il primo campo sar� il tempo iniziale, il secondo quello finale, il terzo sar� il successivo tempo iniziale e cos� via
            </ul>
...
<?php if ($src == "search") : ?>
    <?php if (($x2 != "") && ($x2 != "0")) : ?>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
                Come selezionare il paziente di cui voglio <?php if ($x1 == "edit") print "modificare";
        else print "visualizzare"; ?> il referto di laboratorio?</b>
            </font>
            <ul>       	
                <b>1: </b>selezionare button&nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Referti lab</font></button> corrispondenti al paziente di cui si vuole <?php if ($x1 == "edit") print "modificare";
        else print "visualizzare"; ?> il referto.<p> 
            </ul>
            <img <?php echo createComIcon('../', 'frage.gif', '0') ?>> <font color="#990000"><b>
    ...
    <?php if (($x2 == "") || ($x2 == "0")) : ?>
        ...
        <ul>       	
            ...
            <ul>       	
                <b>Nota: </b>Se la ricerca trova pi� risultati, apparir� una lista.<p>
            </ul>
    <?php if (($x2 == "") || ($x2 == "0")) : ?>
                <b>3: </b>selezionare il bottone &nbsp;<button><img <?php echo createComIcon('../', 'update2.gif', '0') ?>> <font size=1>Referti lab</font></button> corrispondenti al paziente di cui si vuole <?php if ($x1 == "edit") print "modificare";
        else print "visualizzare"; ?> il referto.<p> 
    <?php endif; ?>
        </ul>
        <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Nota:</b></font> 
...
<?php if ($src == "arch") : ?>
    ...
    <?php if (($x3 != "")) : ?>
                                        ...
                                        <ul>       	
                                            <b>1: </b>selezionare il bottone <img src="../img/update3.gif" border=0> posto sotto la data di operazione nella colonna pi� a sinistra per passare al modo modifica.<br>
                                        ...
                                        <ul>       	
                                            ...
                                            <b>2: </b>Apparir� la cartella dei dati paziente. Se occorre selezionare il bottone "Aiuto" per altre istruzioni.<p> 
                                        </ul>
    <?php endif; ?>
                                    <img <?php echo createComIcon('../', 'warn.gif', '0', 'absmiddle') ?>> <font color="#990000"><b> Nota:</b></font> 
                                    <ul>       	
