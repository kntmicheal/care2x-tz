...
# !v!
    ...
    function _validate_nhif_status() {
        global $db;
        $this->sql = "Select `value` FROM `care_config_global` WHERE `type` = 'validate_nhif'";
        $dc = $db->Execute($this->sql);
