...
class Insurance_tz extends Core {
  ...
  // -----------------------------------------------------------------------------
    ...
    if ($this->is_company_just_invoiced($id)) {
    	...
    	$this->sql="SELECT
                  ...
                  care_tz_company.invoice_flag,
                  care_tz_company.credit_preselection_flag,
                  care_tz_company.enable_member_expiry,
                  care_tz_company.hide_company_flag,
                  care_tz_company.prepaid_amount,
  ...
  //------------------------------------------------------------------------------
    ...
    if($dataarray['enable_member_expiry']) $expiry=1; else $expiry=0;
...
";
	...
	$this->result_string .="<option value=\"-2\" selected>-Select insurance Company or Cash-</option>";
	$this->result_string .="<option value=\"-1\">-(Cash)-</option>";
