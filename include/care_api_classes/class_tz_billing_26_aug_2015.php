...
<tbody class="main">
    ...
    function ArchiveBill($bill_number) {
        ...
        $this->sql = "INSERT INTO care_tz_billing_archive_elem
                      (`nr`,`date_change`, `is_labtest`,`is_radio_test`, `is_medicine`, `is_comment`, `is_paid`, `amount`, `days`, `times_per_day`, `price`, `balanced_insurance`, `insurance_id`, `description`, `item_number`, `prescriptions_nr`,`sub_store`,`is_deposit_item`, `User_Id`)
                  SELECT `nr`,`date_change`, `is_labtest`,`is_radio_test`, `is_medicine`, `is_comment`, 1, `amount`, `days`, `times_per_day`, `price`, `balanced_insurance`, `insurance_id`, `description`, `item_number`, `prescriptions_nr`,`sub_store`,`is_deposit_item`,`User_Id` FROM care_tz_billing_elem WHERE `nr`=" . $bill_number;
        $this->result = $db->Execute($this->sql);
