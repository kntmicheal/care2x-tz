...
class DrugsAndServices extends Encounter {
    ...
    function getPrice($nr = 0) {
        if ($this->buffer = $this->getItem($nr, 'unit_price'))
            return $this->buffer;
        return false;
    }
    ...
    function getPrice_1($nr = 0) {
        if ($this->buffer = $this->getItem($nr, 'unit_price_1'))
            return $this->buffer;
        return false;
    }
    ...
    function getPrice_2($nr = 0) {
        if ($this->buffer = $this->getItem($nr, 'unit_price_2'))
            return $this->buffer;
        return false;
    }
    ...
    function getPrice_3($nr = 0) {
        if ($this->buffer = $this->getItem($nr, 'unit_price_3'))
            return $this->buffer;
        return false;
    }
    ...
    function getItemDescription($nr = 0) {
        if ($this->buffer = $this->getItem($nr, 'item_description'))
            return $this->buffer;
        return false;
    }
    ...
    function getItemFullDescription($nr = 0) {
        if ($this->buffer = $this->getItem($nr, 'item_full_description'))
            return $this->buffer;
        return false;
    }
    ...
    function getPurchasingClass($nr = 0) {
        if ($this->buffer = $this->getItem($nr, 'purchasing_class'))
            return $this->buffer;
        return false;
    }
