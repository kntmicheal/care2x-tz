...
<!--*************************** expire date end here****************************************************************************************************-->
        ...
        ?>
                        ...
                        <tr>
                            ...
                            <td class="reg_input">
                                    &nbsp;&nbsp;<FONT SIZE=-1  FACE="Arial"><?php if ($errorzip) echo "<font color=red>";
                                echo $LDPOBOX . " " ?><input name="addr_zip" type="text" size="10" value="<?php echo $addr_zip; ?>" >
                            </td>
                            </tr> -->
        ...
        <?php echo $LDOtherHospitalNr; ?>
                        ...
                        <FONT SIZE=-1  FACE="Arial"><nobr>
                            <input  name="user_id" type="text" value="<?php if (isset($user_id) && $user_id) echo $user_id;
                else echo $_SESSION['sess_user_name'] ?>"  size="35" readonly>
                        </nobr>
                        </td>
                        </tr>
